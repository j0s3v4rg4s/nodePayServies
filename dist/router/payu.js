...
payu.post('/payNoData', (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const { uid, data } = req.body;
    const err = payu_models_1.PayU.validatePayNoData(data);
    if (err == '') {
        try {
            const respond = yield payu_models_1.PayU.payNoData(uid, data);
            const resp = {
                complete: true,
                error: null,
                data: respond
